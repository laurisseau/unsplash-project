...
<body>
    ...
    <?php
        if(isset($_GET['delpro'])){
            $delid = $_GET['delpro'];
            $delproduct = $ct->delproducbycart($delid);
        }
    ?>
...
<td><img class="crt-img" src="admin/<?php echo $result['image']?>"></td>
<td><a onclick = "return confirm('Are You Sure You Would Like To Delete ?')" href="?delpro=<?php echo $result['cartid'];?>">Delete</a></td>
                </tr>

                
            <?php  $total = $result['price'] * $i;  } } ?> 
            ...
            <div class="cart-out">
                <span><a href="unsplash-products.php">Continue shopping</a></span> 
                <span><a href="unsplash-payment.php">Checkout</a>
                </span>
            </div>
